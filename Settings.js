  ...
  return [
    ...
    { key: "ART_KINDS", label: "Prefer", kind: "choice", group: "Artwork",
      options: ["titles snaps boxarts", "titles snaps", "titles", "snaps titles", "boxarts titles snaps",
                "marquees titles snaps", "flyers titles snaps"],
      help: "Which artwork to try first: title screen, in-game snap, box scan, marquee, flyer." },
...
function gameSchema() {
  return [
    ...
    { key: "ART", label: "Artwork", kind: "choice", group: "Artwork",
      options: ["", "titles", "snaps", "boxarts", "marquees", "flyers"],
      labels: { "": "as the arcade", titles: "title screen", snaps: "in-game", boxarts: "box art",
